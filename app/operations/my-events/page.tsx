...
export default function OperationsMyEventsPage() {
    const { user } = useAuth()
    ...
    if (loading) {
        return (
            <div className="space-y-6">
                <div>
                    <h1 className="text-3xl font-bold">Events & Teams</h1>
                    <p className="text-muted-foreground">
                        Register for events and manage your teams
                    </p>
                </div>
        ...
        <div className="space-y-6">
            ...
            <Tabs defaultValue="upcoming" className="space-y-6">
                ...
                <TabsContent value="teams" className="space-y-6">
                    {/* Note: We rely on validation.isComplete. If operations users have incomplete profiles (missing roll no etc), 
              this might block them. However, they usually have pre-filled profiles. 
              If this blocks them, we might need to relax this check or ensure their profile is marked complete. */}
