...
import { IComponent, IIssuance, IDamagedLog } from '@/types/inventory';
import { Loader2, Database, Plus, ClipboardList, LogOut, Upload, Download, Search } from 'lucide-react';
...
export default function AdminInventoryPage() {
    const { user } = useAuth();
    const [activeTab, setActiveTab] = useState<'inventory' | 'addComponent' | 'issued' | 'damaged'>('inventory');
