        ...
        <AnimatePresence>
            {isVisible && (
                ...
                >
                    ...
                    <div className="w-full px-4 md:px-12 py-8 md:py-10 relative z-10 flex flex-col lg:flex-row items-center justify-between gap-4">

                        {/* Left Side: Logos */}
                        <div className="flex items-center gap-4 md:gap-6 flex-shrink-0">
                            {/* RAIoT Logo - Bigger */}
                            <div className="flex items-center gap-3">
                                <div className="relative w-16 h-16 md:w-20 md:h-20 drop-shadow-[0_0_15px_rgba(34,211,238,0.6)]">
                            ...
                            {/* X Separator - Bigger */}
                            <div className="text-cyan-500/50 font-thin text-3xl select-none mx-[-2px]">
                                <X className="w-6 h-6 md:w-8 md:h-8" />
                            </div>

                            {/* Amity Logo - Bigger Container */}
                            <div className="flex items-center gap-4">
                                <div className="relative h-16 md:h-20 w-56 md:w-72 bg-white/95 -skew-x-12 border-r-4 border-cyan-500/50 shadow-[0_0_20px_rgba(255,255,255,0.2)] flex items-center justify-center overflow-hidden">
                        ...
                        {/* Center: Slogan - Perfectly Centered & HUGE */}
                        <div className="hidden lg:flex flex-col items-center justify-center text-center flex-1 mx-4 relative">
                            {/* Glow Effect behind text */}
                            <div className="absolute inset-0 bg-cyan-500/20 blur-3xl opacity-50 rounded-full scale-110" />

                            <h2 className="relative text-4xl md:text-6xl font-black font-orbitron text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 via-white to-cyan-400 animate-gradient-x flex items-center justify-center gap-4 whitespace-nowrap drop-shadow-[0_0_15px_rgba(34,211,238,0.8)] tracking-wide">
                                <Sparkles className="w-8 h-8 md:w-10 md:h-10 text-yellow-400 animate-spin-slow" />
                                JOIN THE BLADE
                                <Sparkles className="w-8 h-8 md:w-10 md:h-10 text-yellow-400 animate-spin-slow" />
                            </h2>
                            <p className="relative text-cyan-100/90 text-sm md:text-lg font-mono mt-2 tracking-[0.2em] uppercase font-bold text-shadow-sm">
                        ...
                        <div className="flex items-center justify-end flex-shrink-0">
                            <TraineeRegistrationModal
                                triggerButton={
                                    <Button
                                        size="lg"
                                        className="relative overflow-hidden bg-cyan-600 hover:bg-cyan-500 text-white rounded-none skew-x-[-10deg] px-10 md:px-16 py-2 border-l-4 border-white/20 shadow-[0_0_30px_rgba(8,145,178,0.4)] transition-all duration-300 hover:scale-105 group h-16 md:h-20"
                                    >
                                        ...
                                        <span className="relative skew-x-[10deg] font-bold font-orbitron tracking-wider text-xl md:text-2xl flex items-center gap-3">
                                            REGISTER <ChevronRight className="w-6 h-6 md:w-8 md:h-8 group-hover:translate-x-1 transition-transform" />
                                        </span>
                                    </Button>
                                }
                            />
