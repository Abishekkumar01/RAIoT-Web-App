...
export default function HoneycombGallery() {
    ...
    return (
        <article className={styles.galleryWrapper}>
            {images.map((src, idx) => {
                ...
                return (
                    <div key={idx} className={styles.galleryItem}>
                        {letter ? (
                            <div className="w-full h-full flex items-center justify-center bg-gray-950 border-2 border-cyan-500/30 relative overflow-hidden group hover:border-cyan-400 transition-colors duration-300">
            ...
            {/* Mobile Background Layer (Positioned at end to preserve nth-child indices for Desktop) */}
